...
Конфигурационный файл `.prettierrc` используется для настройки форматирования кода с помощью инструмента [prettier](../Архив/prettier). Вот описание каждой опции конфигурации:
...
-   `"printWidth": 80"`: определяет, на сколько символов длинными должны быть строки перед автоматическим переносом
...
-   `vueIndentScriptAndStyle`: Specifies whether the script and style tags in [../Vue/Vue.js](#) single file components should be indented. In this case, it is set to true, meaning that they will be indented.
