...
date: 2024-10-12
---
`v-on` — это директива [../../../Vue/Vue.js](#), которая используется для прослушивания событий [DOM](./DOM) и выполнения действий при их возникновении. Например, можно использовать `v-on` для обработки кликов, нажатий клавиш, отправки форм и других событий.
