...
date: 2024-10-13
---
В [JavaScript](../Работа/JavaScript) строка ([string](./string)) — это примитивный тип данных, который представляет собой последовательность символов, используемую для хранения и обработки текстовой информации.
